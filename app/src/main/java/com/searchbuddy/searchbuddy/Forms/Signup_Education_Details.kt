...
import com.bumptech.searchbuddy.databinding.ActivitySignupFormTwoBinding
...
class Signup_Education_Details : AppCompatActivity() {
    ...
    lateinit var EduList: java.util.ArrayList<String>
...
//                LocationList.add(item.toString())
        ...
        val EduAdapter = ArrayAdapter(this, R.layout.simple_spinner_item, EduList)
        ...
        binding.tiGradEduType.setAdapter(EduAdapter)
        binding.tiPostgradEduType.setAdapter(EduAdapter)
        binding.tiGradEduType.setOnItemSelectedListener(object :
            AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                parent: AdapterView<*>,
                view: View,
...
//                LocationList.add(item.toString())
        ...
        binding.tiPostgradEduType.setOnItemSelectedListener(object :
            AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                parent: AdapterView<*>,
                view: View,
...
//                Log.i("Arrraaaaay", exampleCollegeList.toString())
        ...
        val adapter =
            ArrayAdapter(this, R.layout.simple_spinner_dropdown_item, exampleCollegeList)
...
//        yo = UserID.toInt()
        ...
        binding.twelve.setOnClickListener {
            ...
            binding.twelve.visibility=View.VISIBLE
            binding.postGraduate.visibility=View.GONE
            binding.highestQual.visibility=View.GONE
            LocalSessionManager.saveValue(Constant.Highest,"twelve",this)
            binding.twelve.setTextColor(Color.parseColor("#ffffff"))
            binding.twelve.setBackgroundResource(com.bumptech.searchbuddy.R.drawable.work_status_selected_border)
            binding.tenth.setBackgroundResource(com.bumptech.searchbuddy.R.drawable.work_status_border)
            binding.graduate.setBackgroundResource(com.bumptech.searchbuddy.R.drawable.work_status_border)
            binding.postGraduate.setBackgroundResource(com.bumptech.searchbuddy.R.drawable.work_status_border)
        ...
        binding.graduate.setOnClickListener {
            ...
            binding.postGraduate.visibility=View.GONE
            binding.highestQual.visibility=View.GONE
            LocalSessionManager.saveValue(Constant.Highest,"graduate",this)
            binding.graduate.setTextColor(Color.parseColor("#ffffff"))
            binding.graduate.setBackgroundResource(com.bumptech.searchbuddy.R.drawable.work_status_selected_border)
            binding.tenth.setBackgroundResource(com.bumptech.searchbuddy.R.drawable.work_status_border)
            binding.twelve.setBackgroundResource(com.bumptech.searchbuddy.R.drawable.work_status_border)
            binding.postGraduate.setBackgroundResource(com.bumptech.searchbuddy.R.drawable.work_status_border)
        ...
        binding.postGraduate.setOnClickListener{
            ...
            binding.graduate.visibility=View.GONE
            binding.twelve.visibility=View.GONE
            binding.postGraduate.visibility=View.VISIBLE
            binding.highestQual.visibility=View.GONE
            LocalSessionManager.saveValue(Constant.Highest,"postgraduate",this)
            binding.postGraduate.setTextColor(Color.parseColor("#ffffff"))
            binding.postGraduate.setBackgroundResource(com.bumptech.searchbuddy.R.drawable.work_status_selected_border)
            binding.tenth.setBackgroundResource(com.bumptech.searchbuddy.R.drawable.work_status_border)
            binding.twelve.setBackgroundResource(com.bumptech.searchbuddy.R.drawable.work_status_border)
            binding.graduate.setBackgroundResource(com.bumptech.searchbuddy.R.drawable.work_status_border)
