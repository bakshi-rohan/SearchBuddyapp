...
import com.bumptech.searchbuddy.databinding.ActivitySignupPrefrencesBinding
import com.google.gson.Gson
import com.google.gson.JsonArray
import com.google.gson.reflect.TypeToken
import com.searchbuddy.searchbuddy.FirstScreen
import com.searchbuddy.searchbuddy.Profile.PrefrencesViewModel
    ...
    var yo = UserID.toInt()
        ...
        viewModel.UpdatePrefDetail(this, requestParams, binding.progress).observe(this, {
            Toast.makeText(this, "Preferences Updated", Toast.LENGTH_SHORT).show()
                        val builder = AlertDialog.Builder(this)
            builder.setMessage("Succesfully Registered")
