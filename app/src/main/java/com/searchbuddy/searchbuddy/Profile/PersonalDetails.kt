...
import com.bumptech.searchbuddy.databinding.ActivityPersonalDetailsBinding
        ...
        viewModel.requestPersonalDetail(this, yo, binding.progress).observe(this) {
            if (it != null) {
                ...
                if (it.gender != null) {
                    ...
                    } else if (it.gender.id == 4279) {
                        binding.radioOthers.isChecked = true
                    }
                }
...
//    }
    ...
    private fun isValidate(): Boolean =
        validateUserName() && validateDesg()&&validateemail()&&validateMobile()
