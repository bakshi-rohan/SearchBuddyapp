...
import com.bumptech.searchbuddy.databinding.ActivityFragmentBinding
import com.bumptech.searchbuddy.databinding.FilterFooterBinding
...
//                textView.setText("Start value: ${values[0]}, End value: ${values[1]}")
        ...
        exp_start= LocalSessionManager.getFloatValue("SliderStartValueFloat",0F,this@FragmentActivity)!!
        exp_End= LocalSessionManager.getFloatValue("SliderEndValueFloat",0F,this)!!
        ...
        sal_start= LocalSessionManager.getFloatValue("SalarySliderStartValueFloat",0F,this)!!
        sal_End= LocalSessionManager.getFloatValue("SalarySliderEndValueFloat",0F,this)!!
...
//}
        binding.buttonDone.setOnClickListener {
            ...
            LocalSessionManager.saveValue(Constant.FillLocation,"",this)
            LocalSessionManager.saveValue(Constant.DatePost,"All Jobs",this)
            ...
            LocalSessionManager.saveValue(Constant.SliderStartValue,"0",this)
            LocalSessionManager.saveValue(Constant.SliderEndValue,"0",this)
            LocalSessionManager.saveValue(Constant.SalarySliderStartValue,"0",this)
            LocalSessionManager.saveValue(Constant.SalarySliderEndValue,"0",this)
...
//        binding.tiLocationForm.showDropDown()
        ...
        binding.tiLocationForm.setOnItemClickListener(AdapterView.OnItemClickListener { parent, view, position, id ->
            ...
            Log.i("xxxx",location_string.toString())

            LocalSessionManager.saveValue(
                Constant.FilterLocation,
                location_string,
               this
            )
            LocalSessionManager.saveValue(Constant.FillLocation, location_string, this)

        })

        var loc=LocalSessionManager.getStringValue("FillLocation","",this)
        if (loc!=null) {
            binding.tiLocationForm.setText(loc)
            LocalSessionManager.saveValue(Constant.FilterLocation,binding.tiLocationForm.text!!.toString(),this)
        }
...
//                LocationList.add(item.toString())
        ...
        var date_pos_string= LocalSessionManager.getStringValue("DatePost","",this)
    ...
    private fun createDepartmentStatusView() {
        ...
        while (i.hasNext()) {
            ...
            DepartmentcheckBox = CheckBox(this)
