...
import com.example.searchbuddy.Adapter.EducationFieldAdapter
import com.example.searchbuddy.Adapter.ExperienceFieldAdapter
import com.example.searchbuddy.Login.Login
import com.example.searchbuddy.databinding.ActivityFormThreeBinding
import com.example.searchbuddy.model.EducationFieldModel
...
class Form_three : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        parentLinearLayout = findViewById(com.example.searchbuddy.R.id.parent_layout)
//        EduparentLinearLayout = findViewById(com.example.searchbuddy.R.id.edu_parent_layout)
