...
import com.example.searchbuddy.databinding.ActivityEducationDetailsBinding
...
//                            var gread_end_adapter=ENDDateAdapter.getPosition(gradend_substring)
//                            binding.endGrad.setSelection(gread_end_adapter)
                        ...
                        if (it.professionalDetails.educationDetails.graduation.university!=null){
                            ...
                            if (gradUni!=null){
                                var gradUnispinner:Int=adapter.getPosition(gradUni)
                                binding.tiGradUni.setSelection(gradUnispinner)
                            }
                        }
                    }
...
//                                binding.endPostgrad.setSelection(endpostgraadapter)
                        ...
                        if (it.professionalDetails.educationDetails.postGraduation.university!=null){
                            ...
                            if (PostgradUni!=null){
                                var PostGradUniv:Int=adapter.getPosition(PostgradUni)
                                binding.tiPostgradUni.setSelection(PostGradUniv)
                            }
                        }
                    }
                }
