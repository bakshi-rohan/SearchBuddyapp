...
import com.example.searchbuddy.Adapter.WorkHistoryAdapter
...
import com.example.searchbuddy.databinding.ActivityProfessionalDetailsBinding
import com.example.searchbuddy.model.FunctionList
import com.example.searchbuddy.model.GetAllWorkHistoryModelItem
import com.example.searchbuddy.model.IndustryListItem
    ...
    private fun addNewChip(): Boolean {
        ...
        try {
            ...
            val newChip: Chip = LayoutInflater.from(this)
                .inflate(com.example.searchbuddy.R.layout.layout_chip_entry, null) as Chip
